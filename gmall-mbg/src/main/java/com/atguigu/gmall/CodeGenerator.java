...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("H:\\ideaproject\\gmall-parent\\gmall-mbg" + "/src/main/java");
        gc.setAuthor("Lfy");
        ...
        dsc.setUrl("jdbc:mysql://47.75.154.183:3307/gmall_"+moduleName+"?useUnicode=true&useSSL=false&characterEncoding=utf8");
